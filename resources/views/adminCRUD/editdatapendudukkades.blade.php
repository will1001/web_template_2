...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
     ...
     <form action="{{ url('editdatapendudukkades/' .  $data_penduduks[0]->NIK .'/'.$data_penduduks[0]->Id_Dusun ) }}" method="post" enctype="multipart/form-data" class="padding_form">
          {{ csrf_field() }}
          Alamat :<br>
          ...
          <select name="Akta_Lahir">
            <option value="{{$kode_data_akta_lahir_defaults[0]->id}}" selected="true" >{{$kode_data_akta_lahir_defaults[0]->akta_lahir}}</option>                 
