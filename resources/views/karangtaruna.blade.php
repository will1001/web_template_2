...
<body data-spy="scroll" data-target="#primary-menu">
    ...
    <section id="lembaga" class="section-padding">
      <div class="container">
      <h1 class="text-center text-uppercase">Karang Taruna "Rinjani" Desa Perian</h1>
       <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            <h3 class="text-center text-uppercase">Masa Bhakti 2018 - 2020</h3>
            <br><br>
        </div>
      </div>
      <div class="row" id="visimisi">
        <div class="col-md-12">
          ...
          <img src="images/kartaru.jpg" alt="grafik organisasi">
          </div>
