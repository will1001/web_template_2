...
Route::post('/edittemplate/{id}', 'TemplateController@editemplate')->middleware('auth');
Route::get('/formeditemplate/{id}', 'TemplateController@formeditemplate')->middleware('auth');
...
Route::get('/admin', function(){
	if(Auth::user()->roles == "kades" && Auth::user()->status == "aktif"){
		...
		return view('adminkades',['beritas' => $beritas,'data_penduduksjson' => $data_penduduksjson, 'pengumumandesas' => $pengumumandesas,'SOTKs' => $SOTKs,'users' => $users,'kode_area_dusuns' => $kode_area_dusuns,'bumdess' => $bumdess,'jmlbarang' => $jmlbarang,'template' => $template]);
		...
		return view('adminkadus',['users'=> $users ,'data_penduduks' => $data_penduduks,'kode_area_dusuns' => $kode_area_dusuns,'template' => $template]);
